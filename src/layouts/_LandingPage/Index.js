...
import keranjang from "../../assets/img/landing/keranjang.png";
import handphone from "../../assets/img/landing/handphone.png";
    ...
    <div className="landing-page">
      <Row>
        <Col
          ...
          md="5"
          lg="6"
          className="text-container order-lg-2 order-md-1 order-sm-1 order-xs-1"
        >
          <Row>
            <Col>
              <div>
                ...
                <p className="mb-0">
                  Keranjang Belanja Pintar Berbasis Komputer{" "}
                </p>
        ...
        <Col
          ...
          md="7"
          lg="6"
          className="order-lg-1 order-md-2 order-sm-2 order-xs-2"
        >
          <div className="image-container" style={{ height: "700px" }}>
            <img
              className="image handphone-image"
              src={handphone}
              alt="x"
            ></img>
            <img
              className="image keranjang-image"
              src={keranjang}
              alt="x"
            ></img>
          </div>
